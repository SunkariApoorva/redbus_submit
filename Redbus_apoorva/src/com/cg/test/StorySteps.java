...
public void enter_person_details() throws Throwable {
	Thread.sleep(2000);
	SearchResult.name(driver).sendKeys("SunkariApoorva");
  SearchResult.selectGender(driver);
  SearchResult.age(driver).sendKeys("21");
  SearchResult.mail(driver).sendKeys("sunkari.apoorva@gmail.com");
  SearchResult.mob(driver).sendKeys("9502065892");
